...
public class VideoChatActivity_old extends AppCompatActivity {

    private static final String LOG_TAG = VideoChatActivity_old.class.getSimpleName();
    java.util.Timer mTimerFinal;
        ...
        mTimerFinal.scheduleAtFixedRate(new TimerTask() {
            private Handler updateUI = new Handler() {
                ...
                public void dispatchMessage(Message msg) {
                    ...
                    if (one_time) {
                        final Dialog dialog = new Dialog(VideoChatActivity_old.this);
